...
class CoursePointMesg : Mesg, AllFitMesg {
    ...
    var timestamp: DateTime?
         ...
         */
        set(timestamp) {
            setFieldValue(1, 0, timestamp?.timestamp, Fit.SUBFIELD_INDEX_MAIN_FIELD)
        }
    ...
    companion object {
        ...
        // course_point
        val coursePointMesg: Mesg = Mesg("course_point", MesgNum.COURSE_POINT)
